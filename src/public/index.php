...
Router::post('/register', RegisterLoginController::class . '@register')->middleware(VerifyCsrfToken::class);
Router::post('/login', RegisterLoginController::class . '@login')->middleware(VerifyCsrfToken::class);
Router::post('/logout', LogoutController::class . '@logout')->middleware([AuthMiddleware::class, VerifyCsrfToken::class]);
